...
interface StrapiApi {
    ...
    // Weight Loss Stories
    @GET("weight-loss-stories")
    suspend fun getWeightLossStories(
        @Query("populate") populate: String = "users_permissions_user",
        @Header("Authorization") token: String
    ): Response<WeightLossStoryListResponse>

    @GET("weight-loss-stories")
    suspend fun getWeightLossStoriesForUser(
        @Query("filters[users_permissions_user][id][\$eq]") userId: String,
        @Query("populate") populate: String = "users_permissions_user",
        @Header("Authorization") token: String
    ): Response<WeightLossStoryListResponse>

    @POST("weight-loss-stories")
    suspend fun postWeightLossStory(
        @Body body: WeightLossStoryBody,
        @Header("Authorization") token: String
    ): Response<WeightLossStoryResponse>

    @PUT("weight-loss-stories/{id}")
    suspend fun updateWeightLossStory(
        @Path("id") id: String,
        @Body body: WeightLossStoryBody,
        @Header("Authorization") token: String
    ): Response<WeightLossStoryResponse>
    ...
    suspend fun getPacks(
        @Query("filters[gliders][id][\$eq]") userId: String,
        @Header("Authorization") token: String
    ...
    suspend fun getPosts(
        @Query("filters[pack][id][\$eq]") packId: String? = null,
        @Header("Authorization") token: String
    ...
    suspend fun getChallenges(
        @Query("filters[challengerId][id][\$eq]") userId: String,
        @Header("Authorization") token: String
    ...
    data class SleepLogEntry(
        ...
        @SerializedName("documentId") val documentId: String,
        @SerializedName("sleep_log_id") val sleepLogId: String?,
        @SerializedName("sleep_duration") val sleepDuration: Float,
        @SerializedName("deep_sleep_duration") val deepSleepDuration: Float,
        @SerializedName("rem_sleep_duration") val remSleepDuration: Float,
        @SerializedName("light_sleep_duration") val lightSleepDuration: Float,
    ...
    data class UserEntry(
        ...
        val maxGreetingsEnabled: Boolean?,
    ...
    // Weight Loss Stories
    data class WeightLossStoryBody(val data: WeightLossStoryRequest)
    data class WeightLossStoryRequest(
        @SerializedName("storyId") val storyId: String,
        @SerializedName("thenWeight") val thenWeight: Double,
        @SerializedName("nowWeight") val nowWeight: Double,
    ...
    data class WeightLossStoryEntry(
        @SerializedName("id") val id: Int,
        @SerializedName("documentId") val documentId: String,
        @SerializedName("storyId") val storyId: String?,
        @SerializedName("thenWeight") val thenWeight: Double?,
    ...
    data class CommentEntry(
        @SerializedName("id") val id: String,
        @SerializedName("post") val post: UserId,
        @SerializedName("user") val user: UserId,
